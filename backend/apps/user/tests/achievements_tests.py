...
class AchievementsTest(APITestCase, UserMixin):
    def setUp(self):
        ...
        self.achievement = Achievement.objects.create(
            name="Conquista", category="TESTE", condition="Teste"
        )

        self.achievement2 = Achievement.objects.create(
            name="Conquista2", category="TESTE2", condition="Teste2"
        )
        ...
        self.userachievement2 = AchievementLog.objects.create(
            user=self.user, achievement=self.achievement2
        )
    ...
    def test_get_achievements_user(self):
        url = reverse("user:achievements_user")
