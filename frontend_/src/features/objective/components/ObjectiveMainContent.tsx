...
import ObjectiveProgressCard from '@/features/objective/components/ObjectiveProgressCard';
import ObjectiveStreakSection from '@/features/objective/components/ObjectiveStreakSection';
import ObjectiveRateSection from '@/features/objective/components/ObjectiveRateSection';
import ObjectiveConclusionSection from '@/features/objective/components/ObjectiveConclusionSection';
import ObjectiveCalendarSection from '@/features/objective/components/ObjectiveCalendarSection';
import ObjectiveDisplayCard from '@/share/components/specific/ObjectiveCard';
import ObjectiveFooter from '@/features/objective/components/ObjectiveFooter';
