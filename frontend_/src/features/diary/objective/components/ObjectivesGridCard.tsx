...
const ObjectiveGridItem: React.FC<ObjectiveGridItemProps> = ({
  label,
  renderIcon,
  isSelected,
  onPress,
...
const styles = StyleSheet.create({
  ...
  objectiveGridItemSelected: {
    borderColor: '#79D457', // Borda verde mais escura quando selecionado
  },
  iconWrapper: {
    // Wrapper para dar um tamanho consistente aos ícones customizados (SVGs)
